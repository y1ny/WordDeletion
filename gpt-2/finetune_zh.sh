...
echo $MASTER_PORT
MODEL="/path/to/gpt2-chinese-cluecorpussmall" # Set the path if you do not want to load from huggingface directly
...
DATA="data/exp1-zh/train_data.csv"
EVAL_DATA="data/exp1-zh/train_data.csv"
...
do
    for n in {0..9};
    do
        torchrun $DISTRIBUTED_ARGS finetune_zh.py \
        ...
        python evaluation_zh.py \
            --n_training_sample $s \
            --n_iter $n \
            --model_path /path/to/model \
            --test_path data/exp1-zh/test_sentence.csv \
            --output_path result/exp1-zh/
    done
done