...
class DeletionDataset:
    """
    dataset module for word deletion
    """
    ...
    def __init__(self, global_config):
        ...
        # whether preprocessing word deletion dataset
    ...
    def get_dataloader(self, batch_size, type, num_workers, shuffle):
        ...
        :param batch_size:
        :param type: 'train' or 'dev' or 'test'
        :return:
        """
    ...
    def get_all_samples_id(self, type):
        """
        get samples id of 'train' or 'dev' or 'test' data
        :param type:
        :return:
        """
        data = self._data[type]
    ...
    def word_char2id(self, w):
        ...
        # print(self._char2id[b'\xc3\x83'])
        for ch in w:
            if chr(ch).encode('utf-8') == b'\xc3\x83':
                t=1
        w_id = map(lambda ch: self._char2id[chr(ch).encode('utf-8')], w)
        tmp = list(w_id)
    ...
    def gather_context_seq_len(self, type, steps=None):
        ...
        :param type: 'train' or 'dev' or 'test' data
